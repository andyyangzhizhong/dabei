...
public class EnterpriseServiceFragment extends BaseFragment {
    ...
    public static EnterpriseServiceFragment newInstance() {
        return new EnterpriseServiceFragment();
    }
    ...
    private void loadData(boolean isRefresh) {
        new GetRecommendServiceRequester(classId, curPage, PAGE_SIZE, "1", new OnHttpResponseCodeListener<List<RecommendServiceInfo>>() {
            @Override
