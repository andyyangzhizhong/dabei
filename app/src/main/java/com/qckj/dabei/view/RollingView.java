...
public class RollingView extends FrameLayout implements View.OnClickListener {
    ...
    public RollingView(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.RollingView);

        mTextSize = a.getDimension(R.styleable.RollingView_textSize, mTextSize);
        mTextColor = a.getColor(R.styleable.RollingView_textColor, mTextColor);
